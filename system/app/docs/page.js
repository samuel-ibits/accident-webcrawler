    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal ml-6">
          <li className="mb-2">Access the Dashboard: Navigate to the Dashboard Scraper by visiting the provided URL or by launching the application locally if you're running it on your machine.</li>
          <li className="mb-2">Site Selection: Upon accessing the dashboard, you'll find a list of supported sites. Select the website you want to scrape from the available options.</li>
          ...
          <li className="mb-2">Initiate Scraping: Once the configuration is complete, initiate the scraping process by clicking the "Scrape" button. The scraper will start fetching data from the chosen website according to your configured settings.</li>
      ...
      <section>
        ...
        <ol className="list-decimal ml-6">
          ...
          <li className="mb-2">Activate the Extension: Click on the extension icon in your browser's toolbar to activate it. The extension will display options for configuring the scraping process.</li>
